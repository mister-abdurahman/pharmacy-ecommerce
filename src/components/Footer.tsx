...
function Footer() {
  return (
    <div className="mt-auto px-8 sm:px-12 pt-6 sm:pt-12 pb-7 text-sm bg-primary-dark text-white flex flex-col gap-8">
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between">
        <div>
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <p className="text-xs flex items-center gap-1">
              {" "}
              <FaPhoneAlt /> 090000000000000
            </p>
            <p className="text-xs flex items-center gap-1">
              {" "}
              <IoIosMail className="w-4 h-4" /> asssss@gmail.com
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="space-y-1 sm:space-y-2">
            <p className="text-xs">Family Medicine</p>
            <p className="text-xs">Family Medicine</p>
            <p className="text-xs">Family Medicine</p>
          </div>
        </div>
