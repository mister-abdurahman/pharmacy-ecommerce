  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-brand_green_700 hover:bg-white hover:text-brand_green_700 transition-colors duration-300">
          Create a Prescription <FaPrescriptionBottleMedical />
        </Button>
