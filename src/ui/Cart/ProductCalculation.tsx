...
import { countries, states } from "@/_lib/helper";
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mx-4 justify-center">
      ...
      <div className="flex flex-col basis-1/2 gap-2">
        <div className="bg-gray-200 p-6 border-2 border-gray-500 rounded-md">
          ...
          <div className="border-t-2 border-b-2 border-gray-500 my-6 py-3">
