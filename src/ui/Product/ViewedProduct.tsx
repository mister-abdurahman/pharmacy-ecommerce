...
import { ICategory, IProduct } from "@/_lib/types";
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:justify-center items-center">
        ...
        <div className="space-y-6 sm:basis-1/2">
          ...
          <div className="flex sm:Flex-row flex-col gap-3">
            ...
            <Button className="bg-brand_green_700">Proceed to checkout</Button>
          </div>

          <div>
            <h1>Share this product</h1>
            <div className="flex items-center gap-2">
              <FaXTwitter className="bg-gray-200 rounded-md p-2 w-9 h-9" />
              <FaFacebookF className="bg-gray-200 rounded-md p-2 w-9 h-9" />
              <IoLogoWhatsapp className="bg-gray-200 rounded-md p-2 w-9 h-9" />
            </div>
          </div>
        </div>
      </div>
